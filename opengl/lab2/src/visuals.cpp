...
// c is char pressed, and x,y is the corresponding mouse coords
void KeyboardGL( unsigned char c, int x, int y )
{
	...
	case '5':
		...
		break;
	case '6':
		glClearColor( 0.0f, 0.0f, 0.4f, 0.0f );                      // Light-Gray background
		g_eCurrentScene = 6;
		break;
	case 's':
	case 'S':
...
void RenderScene6()
{
	...
	// Draw the triangle !
	glDrawArrays(GL_TRIANGLES, 3, 12); // 3 indices starting at 0 -> 1 triangle
...
void SetupGL() //
{
	...
	//Parameter handling
	// specifies a symbolic value representing a shading technique, GL_FLAT or GL_SMOOTH
	glShadeModel (GL_SMOOTH);

	// if enables, do depth comparisons and update the depth buffer
