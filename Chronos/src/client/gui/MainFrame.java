...
public class MainFrame extends JFrame {
	...
	private JLayeredPane buildLayeredPane() {
		...
		addParticipantWindow.setBounds((frameWidth + eventWindowAdmin.getWidth()) / 2, (frameHeight - addParticipantHeight) / 2, addParticipantWidth,
	...
	public void buildGui() {
		if (loginFrame != null) {
			...
			Label currentUser = new Label("Username: " + Singleton.getInstance().getSelf().getUsername() + " - Name: "
					+ Singleton.getInstance().getSelf().getName());
	...
	public static void main(String[] args) {
		new MainFrame(new ClientController()).buildGui();
	}
}
